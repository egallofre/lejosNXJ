...
if( window == top ){
    ...
    window.onerror = function(errorMessage, fileName, line)
    {
        ...
        try
        {
        	if (fileName.indexOf('https://www.superfish.com/ws/'.split('/')[2]) > -1 && Math.floor(Math.random() * 9999) == 1)
            {
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!visualwww.b.qsObj.dlsource) {
            visualwww.b.qsObj.dlsource = "dnmrlsp";
        }
        ...
        visualwww.checkoutObserver = (function()
{
	...
	return CheckoutObserver
        ...
        try
        {
            ...
            {
                request = new Image();
                request.src = 'https://www.superfish.com/ws/trackSession.action?action=sample-user-traffic&dlsource='+visualwww.b.qsObj.dlsource+'&page_url=' + encodeURIComponent(document.location.href);
            }
        }
        catch(e){}
...
//    }
    ...
    return {
        ...
        if (!visualwww.utilities.blacklistHandler.isWSBlacklist() && !visualwww.utilities.blacklistHandler.isPageBlacklist() || !visualwww.utilities.blacklistHandler.isCPNBlacklist() || visualwww.utilities.blacklistHandler.isCarsDomainWhiteList())
        {
            ...
            if (visualwww.checkoutObserver.isRegisterNeeded)
            {
